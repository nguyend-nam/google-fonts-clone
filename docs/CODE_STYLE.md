The project strives to follow the Code Style convention from [dwarvesf](https://github.com/dwarvesf). View the repo at [dwarvesf/nextjs-boilerplate](https://github.com/dwarvesf/nextjs-boilerplate)
