...
interface DropdownProps {
  displayValue: string
  options: string[]
  optionsClick: (val: string) => void
  className?: string
}

export const DropdownButtonString = (props: DropdownProps) => {
  ...
  return (
    <div className="relative">
      <button
        onClick={openSideBar}
        className={cx(
          'p-2 w-28 flex justify-between items-center rounded-md hover:bg-blue-50 hover:text-blue-700',
          {
      ...
      <div
        className={cx(
          'shadow-lg border border-gray-100 mt-1 rounded-xl bg-white h-40 w-32 overflow-auto',
          {
